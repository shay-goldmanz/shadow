...
export function serializeVolumeDocument(
  ...
  const document: Record<string, unknown> = {
    ...
    ...(volume.staleAfter !== null ? { stale_after: toDateString(volume.staleAfter) } : {}),
    generated: { by: volume.generated.by, at: volume.generated.at.toISOString() },
    ...(volume.verified.length > 0
      ? { verified: volume.verified.map((v) => ({ by: v.by, at: v.at.toISOString() })) }
      : {}),
